(function() {
    ...
    var FILES = { staff: 'content/staff.json', disciplines: 'content/disciplines.json', week: 'content/week.json', dpo: 'content/dpo.json' };
    ...
    function loadAll() {
        saving(true);
        Promise.all([loadFile('staff'), loadFile('disciplines'), loadFile('week'), loadFile('dpo')]).then(function() {
    ...
    function render() {
        ...
        var fn = { staff: renderStaff, disciplines: renderDisc, week: renderWeek, dpo: renderDpo };
